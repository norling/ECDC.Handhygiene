...
namespace Fhi.Handhygiene.Dataaksess.Migrations
{
    ...
    [Migration("20210709115840_Observator")]
    partial class Observator
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fhi.Handhygiene.Domene.Sesjon.OverføringstatusType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("OverføringstatusType");
                });
            ...
            modelBuilder.Entity("Fhi.Handhygiene.Domene.Sesjon.Sesjon", b =>
                {
                    ...
                    b.Property<int?>("OverføringstatusId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Fhi.Handhygiene.Domene.Sesjon.Sesjon", b =>
                {
                    ...
                    b.HasOne("Fhi.Handhygiene.Domene.Sesjon.OverføringstatusType", "Overføringstatus")
                        .WithMany("Sesjoner")
                        .HasForeignKey("OverføringstatusId");

                    b.Navigation("Avdeling");

                    b.Navigation("Observator");

                    b.Navigation("Overføringstatus");
                });
